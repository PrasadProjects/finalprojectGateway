      ...
      <form  action="payscript.php" method="post" style="padding: 25px;">
        ...
        <div class="row" >
          <div class="col-25">
            ...
            <input type="text" id="fname" name="name" placeholder="Prasad Nimse">
            <label for="email"><i class="fa fa-envelope"></i> Email</label>
            <input type="text" id="email" name="email" placeholder="prasad@example.com">
            <input type="hidden" value="<?php echo 'OID'.rand(100,1000);?>" name="orderid">
            <label for="amount"><i class="fa fa-inr"></i> Amount</label>
            <input type="text" id='amount' name="payment" placeholder="amount">
